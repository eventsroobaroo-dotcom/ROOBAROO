...
const API_CONFIG = {
    ...
    BASE_URL: 'https://your-backend-url.railway.app/api',
...
function initializePaymentPage() {
    ...
    completePaymentBtn.addEventListener('click', function() {
        if (validatePaymentForm()) {
            console.log('Payment completed'); // Debug log
...
function updatePaymentPage() {
    ...
    if (priceDisplay && registrationData && registrationData.status) {
        ...
        console.log('Updated price to:', price); // Debug log
    }
}
...
// Enhanced hover effects - Updated for new navigation (removed Book Now hover as requested)
